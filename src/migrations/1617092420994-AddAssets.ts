...
export class AddAssets1617092420994 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "assets_history_type_enum" AS ENUM('ASSET_CREATED', 'ASSET_OFFERED', 'ASSET_OFFER_CANCELED', 'ASSET_TRANSFERRED', 'ASSET_OFFER_REJECTED')`);
